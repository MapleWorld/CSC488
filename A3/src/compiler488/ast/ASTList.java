...
public class ASTList<E> extends AST {
    /*
     * Keep the list here. We delegate rather than subclass LinkedList because
     * Java won't let us override the return type for addLast.
     */
     ...
     * <b>printOn(out,depth)</b>. This should only be used when the elements are
     * typically printed on separate lines, otherwise they may not implement
     * <b>printOn</b>. If the list is empty, print <b>&gt;&gt;empty&lt;&lt;</b>
