 ...
 * 
 * @version Fri Feb 10 05:38:38 EST 2017
 */
public class Parser extends java_cup.runtime.lr_parser {
	...
	protected static final short _production_table[][] = unpackFromStrings(
			new String[] { "\000\126\000\002\002\004\000\002\002\003\000\002\005"
					...
					+ "\011\000\002\036\003\000\002\036\003\000\002\036\003" + "\000\002\017\003\000\002\017\006" });
	...
	protected static final short[][] _action_table = unpackFromStrings(
			new String[] { "\000\252\000\004\040\006\001\002\000\004\002\254\001"
					...
					+ "\uffef\021\uffef\022\uffef\023\uffef\026\uffef\031\uffef\033\uffef"
					+ "\040\uffef\041\uffef\055\uffef\001\002\000\004\002\001\001" + "\002" });
	...
	protected static final short[][] _reduce_table = unpackFromStrings(
			new String[] { "\000\252\000\006\002\003\005\004\001\001\000\002\001"
					...
					+ "\075\035\064\036\073\001\001\000\002\001\001\000\002" + "\001\001" });
...
class CUP$Parser$actions {
	...
	public final java_cup.runtime.Symbol CUP$Parser$do_action(int CUP$Parser$act_num,
		...
		case 83: // constant ::= FALSE
		{
			...
			CUP$Parser$result = parser.getSymbolFactory().newSymbol("constant", 28,
					((java_cup.runtime.Symbol) CUP$Parser$stack.peek()),
					((java_cup.runtime.Symbol) CUP$Parser$stack.peek()), RESULT);
		}
			return CUP$Parser$result;
		...
		/* . . . . . . . . . . . . . . . . . . . . */
		case 80: // primary ::= L_PAREN expression QUESTION expression COLON
					// expression R_PAREN
		{
			Object RESULT = null;

			CUP$Parser$result = parser.getSymbolFactory().newSymbol("primary", 27,
		...
		case 75: // factor ::= MINUS factor
		{
			...
			CUP$Parser$result = parser.getSymbolFactory().newSymbol("factor", 26,
		...
		case 73: // term ::= term DIVIDE factor
		{
			...
			CUP$Parser$result = parser.getSymbolFactory().newSymbol("term", 25,
					((java_cup.runtime.Symbol) CUP$Parser$stack.elementAt(CUP$Parser$top - 2)),
					((java_cup.runtime.Symbol) CUP$Parser$stack.peek()), RESULT);
		}
			return CUP$Parser$result;
		...
		case 70: // arithExpn ::= arithExpn MINUS term
		{
			...
			CUP$Parser$result = parser.getSymbolFactory().newSymbol("arithExpn", 24,
					((java_cup.runtime.Symbol) CUP$Parser$stack.elementAt(CUP$Parser$top - 2)),
					((java_cup.runtime.Symbol) CUP$Parser$stack.peek()), RESULT);
		}
			return CUP$Parser$result;
		...
		case 67: // compareExpn ::= arithExpn GREATER EQUAL arithExpn
		{
			...
			CUP$Parser$result = parser.getSymbolFactory().newSymbol("compareExpn", 23,
					((java_cup.runtime.Symbol) CUP$Parser$stack.elementAt(CUP$Parser$top - 3)),
					((java_cup.runtime.Symbol) CUP$Parser$stack.peek()), RESULT);
		}
			return CUP$Parser$result;
		...
		case 60: // negation ::= NOT negation
		{
			...
			CUP$Parser$result = parser.getSymbolFactory().newSymbol("negation", 22,
					((java_cup.runtime.Symbol) CUP$Parser$stack.elementAt(CUP$Parser$top - 1)),
					((java_cup.runtime.Symbol) CUP$Parser$stack.peek()), RESULT);
		}
			return CUP$Parser$result;
		...
		case 58: // conjunction ::= conjunction AND negation
		{
			...
			CUP$Parser$result = parser.getSymbolFactory().newSymbol("conjunction", 21,
					((java_cup.runtime.Symbol) CUP$Parser$stack.elementAt(CUP$Parser$top - 2)),
					((java_cup.runtime.Symbol) CUP$Parser$stack.peek()), RESULT);
		}
			return CUP$Parser$result;
		...
		case 56: // expression ::= expression OR conjunction
		{
			...
			CUP$Parser$result = parser.getSymbolFactory().newSymbol("expression", 14,
					((java_cup.runtime.Symbol) CUP$Parser$stack.elementAt(CUP$Parser$top - 2)),
					((java_cup.runtime.Symbol) CUP$Parser$stack.peek()), RESULT);
		}
			return CUP$Parser$result;
		...
		case 54: // parameter ::= IDENT COLON type
		{
			...
			CUP$Parser$result = parser.getSymbolFactory().newSymbol("parameter", 20,
					((java_cup.runtime.Symbol) CUP$Parser$stack.elementAt(CUP$Parser$top - 2)),
					((java_cup.runtime.Symbol) CUP$Parser$stack.peek()), RESULT);
		}
			return CUP$Parser$result;
		...
		case 53: // parameters ::= parameters COMMA parameter
		{
			...
			CUP$Parser$result = parser.getSymbolFactory().newSymbol("parameters", 12,
					((java_cup.runtime.Symbol) CUP$Parser$stack.elementAt(CUP$Parser$top - 2)),
					((java_cup.runtime.Symbol) CUP$Parser$stack.peek()), RESULT);
		}
			return CUP$Parser$result;
		...
		case 51: // arguments ::= arguments COMMA expression
		{
			...
			CUP$Parser$result = parser.getSymbolFactory().newSymbol("arguments", 11,
					((java_cup.runtime.Symbol) CUP$Parser$stack.elementAt(CUP$Parser$top - 2)),
					((java_cup.runtime.Symbol) CUP$Parser$stack.peek()), RESULT);
		}
			return CUP$Parser$result;
		...
		case 49: // inputs ::= inputs COMMA variable
		{
			...
			CUP$Parser$result = parser.getSymbolFactory().newSymbol("inputs", 16,
					((java_cup.runtime.Symbol) CUP$Parser$stack.elementAt(CUP$Parser$top - 2)),
					((java_cup.runtime.Symbol) CUP$Parser$stack.peek()), RESULT);
		}
			return CUP$Parser$result;
		...
		case 47: // output ::= NEWLINE
		{
			...
			CUP$Parser$result = parser.getSymbolFactory().newSymbol("output", 9,
					((java_cup.runtime.Symbol) CUP$Parser$stack.peek()),
					((java_cup.runtime.Symbol) CUP$Parser$stack.peek()), RESULT);
		}
			return CUP$Parser$result;
		...
		case 44: // outputs ::= outputs COMMA output
		{
			...
			CUP$Parser$result = parser.getSymbolFactory().newSymbol("outputs", 17,
					((java_cup.runtime.Symbol) CUP$Parser$stack.elementAt(CUP$Parser$top - 2)),
					((java_cup.runtime.Symbol) CUP$Parser$stack.peek()), RESULT);
		}
			return CUP$Parser$result;
		...
		case 40: // bound ::= MINUS INTCONST
		{
			...
			CUP$Parser$result = parser.getSymbolFactory().newSymbol("bound", 18,
					((java_cup.runtime.Symbol) CUP$Parser$stack.elementAt(CUP$Parser$top - 1)),
					((java_cup.runtime.Symbol) CUP$Parser$stack.peek()), RESULT);
		}
			return CUP$Parser$result;
		...
		case 38: // variablename ::= IDENT L_SQUARE bound DOT DOT bound R_SQUARE
		{
			...
			CUP$Parser$result = parser.getSymbolFactory().newSymbol("variablename", 15,
					((java_cup.runtime.Symbol) CUP$Parser$stack.elementAt(CUP$Parser$top - 6)),
					((java_cup.runtime.Symbol) CUP$Parser$stack.peek()), RESULT);
		}
			return CUP$Parser$result;
		...
		case 35: // variablenames ::= variablenames COMMA variablename
		{
			...
			CUP$Parser$result = parser.getSymbolFactory().newSymbol("variablenames", 8,
					((java_cup.runtime.Symbol) CUP$Parser$stack.elementAt(CUP$Parser$top - 2)),
					((java_cup.runtime.Symbol) CUP$Parser$stack.peek()), RESULT);
		}
			return CUP$Parser$result;
		...
		/* . . . . . . . . . . . . . . . . . . . . */
		case 33: // declaration ::= PROCEDURE IDENT L_PAREN parameters R_PAREN
					// scope
		{
			Object RESULT = null;

			CUP$Parser$result = parser.getSymbolFactory().newSymbol("declaration", 2,
		...
		/* . . . . . . . . . . . . . . . . . . . . */
		case 31: // declaration ::= FUNCTION IDENT L_PAREN parameters R_PAREN
					// COLON type scope
		{
			Object RESULT = null;
		...
		case 28: // procedureCall ::= IDENT L_PAREN arguments R_PAREN
		{
			...
			CUP$Parser$result = parser.getSymbolFactory().newSymbol("procedureCall", 19,
					((java_cup.runtime.Symbol) CUP$Parser$stack.elementAt(CUP$Parser$top - 3)),
					((java_cup.runtime.Symbol) CUP$Parser$stack.peek()), RESULT);
		}
			return CUP$Parser$result;
		...
		/* . . . . . . . . . . . . . . . . . . . . */
		case 26: // unmatchedStatement ::= IF expression THEN matchedStatement
					// ELSE unmatchedStatement
		{
			Object RESULT = null;

			CUP$Parser$result = parser.getSymbolFactory().newSymbol("unmatchedStatement", 7,
					((java_cup.runtime.Symbol) CUP$Parser$stack.elementAt(CUP$Parser$top - 5)),
					((java_cup.runtime.Symbol) CUP$Parser$stack.peek()), RESULT);
		}
			return CUP$Parser$result;
		...
		case 9: // statement ::= matchedStatement
		{
			...
			System.out.println("Test: " + ((java_cup.runtime.Symbol) CUP$Parser$stack.peek()).value);
